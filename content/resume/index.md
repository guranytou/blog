---
title: "職務経歴書"
date: 2026-01-05T09:38:49+09:00
draft: false
...
## 職務経歴
### 株式会社Finatext(2023年4月 - 現在)
#### 証券サービスの開発環境改善・インフラ改善(2024年1月 - 現在)
- 職種: SRE
- 役割: メンバー
- チーム: 3人
- 技術スタック: AWS、Go、Terraform、Github
- 詳細:
証券サービス全体で利用するプラットフォームの開発環境・インフラの改善や各種パートナー向けサービスのインフラ周りの改善に従事。
- 複数あったTerraformリポジトリの統合および必要なmoduleの共通化とマルチクラウド対応
- AWSやGoの各種EOL対応
- Terraformリポジトリの各種整備
  - 共通moduleの設計・開発・展開
  - moduleの自動ドキュメント化
...
#### パートナー企業向け証券サービスのサーバサイド開発(2023年4月 - 2023年12月)
- 職種: サーバサイドエンジニア
- 役割: メンバー
- チーム: 8人
- 技術スタック: AWS、Go、Terraform、Github
- 詳細:
協業しているパートナー企業向けに証券サービスを提供するプラットフォームの開発に従事。
- パートナー企業担当者や社内CS担当者向けが利用する、証券サービス利用者への一括メール送信機能の開発
- 法人利用者向けの譲渡益税計算用データ提供機能の開発
- 新規パートナー企業に提供するサービス一式の構築
...
#### 将来ありたいエンジニア像
- 1ホップ隣の同僚やサービスの向こう側にいる利用者の方が「手触りが良い」と思える体験を提供できるスキルセットを持った人
  - スキルセットはエンジニアスキル・ヒューマンスキルどちらもバランス良くある人でありたいです
